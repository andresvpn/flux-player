...
(() => {
  ...
  if (urlActualDelScript !== rutaPermitida) {
    document.body.innerHTML = `
      <style>body{background:#111;color:#fff;font-family:sans-serif;text-align:center;padding:2rem;}</style>
      <h1>🚫 Reproductor clonado</h1>
      <p>Este reproductor no está autorizado para usarse desde:</p>
      <code>${urlActualDelScript}</code>
    `;
